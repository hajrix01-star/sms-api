...
- يستطيع تصدير آخر 200 رسالة لكل مرسل تختاره في ملف JSON لعينة بناء القواعد.
- يخفي رمز OTP داخل ملف العينة، ويفتح مشاركة الملف فقط عندما تضغط زر التصدير.
